...
for subj = 1:ns
    ...
    for t = 1:Nt
        ...
        I1 = func_organize_spectrograms_data3(S_ch,freq,xt,[0, 45]);
        I2 = func_organize_spectrograms_data3(CW_ch,cf,xt_cwt,[1-eps, 45]);
        I3 = func_organize_spectrograms_data3(DWV_ch,bf,xt_dwv,[1-eps, 45]);
    ...
    if ~exist('Dataset3_CNN_features','dir')
        mkdir('Dataset3_CNN_features')
    end
    save(['Dataset3_CNN_features/' fname_out],'feat_struct')
