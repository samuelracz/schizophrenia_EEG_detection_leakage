...
fnames = dir('Dataset2_REVE_features/*.mat');
ns = length(fnames);
...
fprintf('Leaky 7-Fold CV Mean Accuracy: %.2f%% (SD: %.2f%%)\n', meanAcc*100, stdAcc*100);
...
stdAcc = std(acc_subj);
fprintf('Subject-based 7-Fold CV Mean Accuracy: %.2f%% (SD: %.2f%%)\n', meanAcc*100, stdAcc*100);
...
save('ws_perf_FM_dataset2.mat','perf_leaky','perf_subj')